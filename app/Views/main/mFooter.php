                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mt_sm--50">
                    <div class="footer-two-single-wized two">
                        <div class="wized-title-area">
                            <h5 class="wized-title">Our Location</h5>
                            <img src="<?=base_url('assets/images/footer/under-title-2.png')?>" alt="finbiz_footer">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-h-2-wrapper">
                        <p class="disc">
                            Klients Aspire - Copyright 2024. All rights reserved.
                        </p>
                        <div class="right">
                            <ul>
    ...
    <script src="<?=base_url('assets/js/vendor/jqueryui.js')?>"></script>
    <script src="<?=base_url('assets/js/vendor/waypoint.js')?>"></script>
    <script src="<?=base_url('assets/js/plugins/swiper.js')?>"></script>
    <script src="<?=base_url('assets/js/plugins/counterup.js')?>"></script>
    <script src="<?=base_url('assets/js/plugins/sal.min.js')?>"></script>
    <script src="<?=base_url('assets/js/vendor/bootstrap.min.js')?>"></script>

    <script src="<?=base_url('assets/js/vendor/waw.js')?>"></script>
    <script src="<?=base_url('assets/js/plugins/contact.form.js')?>"></script>
    <!-- main Js -->
